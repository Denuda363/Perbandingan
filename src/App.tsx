...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col text-slate-900 pb-20 sm:pb-12">
              ...
              <div className="flex items-center gap-2.5 self-end md:self-auto flex-wrap">
                ...
                <div className="flex items-center gap-1.5 text-xs">
                  ...
                  <select
                    ...
                    className="bg-slate-50 border border-slate-200 rounded-lg px-2 py-1.5 text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 cursor-pointer"
                  >
      ...
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-slate-200 px-2 py-1.5 flex items-center justify-around shadow-lg">
        <button
          onClick={() => setCurrentView('cards')}
          className={`flex flex-col items-center gap-0.5 py-1 px-2 rounded-lg text-[10px] font-medium transition-colors ${
            currentView === 'cards' ? 'text-emerald-600 font-bold' : 'text-slate-500'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 px-2 rounded-lg text-[10px] font-medium transition-colors ${
            currentView === 'matrix' ? 'text-emerald-600 font-bold' : 'text-slate-500'
          }`}
        >
        ...
        <button
          ...
          className="flex flex-col items-center -mt-4 bg-emerald-600 text-white w-10 h-10 rounded-full justify-center shadow-md shadow-emerald-200 active:scale-95 transition-transform"
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 px-2 rounded-lg text-[10px] font-medium transition-colors ${
            currentView === 'simulation' ? 'text-emerald-600 font-bold' : 'text-slate-500'
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-0.5 py-1 px-2 rounded-lg text-[10px] font-medium transition-colors ${
            currentView === 'suppliers' ? 'text-emerald-600 font-bold' : 'text-slate-500'
          }`}
        >
      ...
      {/* Toast Notification */}
      {toastMessage && (
        <div className="fixed bottom-16 sm:bottom-6 right-4 sm:right-6 z-50 bg-slate-900 text-white px-4 py-2.5 rounded-xl shadow-lg text-xs font-medium flex items-center gap-2 animate-in fade-in slide-in-from-bottom-3 duration-200">
